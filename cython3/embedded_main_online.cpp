...
main(int argc, char *argv[])
{
    ...
    if (PyImport_AppendInittab("nmpc_vel_ref_online", PyInit_nmpc_vel_ref_online) == -1) {
    ...
    pmodule = PyImport_ImportModule("nmpc_vel_ref_online");
    if (!pmodule) {
        PyErr_Print();
        fprintf(stderr, "Error: could not import module 'nmpc_vel_ref'\n");
