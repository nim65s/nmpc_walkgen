...
if __name__ == '__main__':
   ...
   # secmarginx = 0.09
   # secmarginy = 0.05
   # gen.set_initial_values(comx,comy,comz,\
   ...
   # inter = Interpolation(samplingPeriod, gen)

   # comTraj = numpy.empty( (0,) , dtype=object )
   # zmpTraj = numpy.empty( (0,) , dtype=object )
   ...
   #     inter.interpolate(gen.F_k_x,gen.F_k_y,jerkX, jerkY,comTraj, zmpTraj)
